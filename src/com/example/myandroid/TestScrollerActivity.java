...
public class TestScrollerActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btn1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				mScroller.startScroll(0, 0, -300, -300, 5000);
			}
		});
		...
		lay1.addView(btn1);
		lay2.addView(btn2);
		lay1.setOverScrollMode(View.OVER_SCROLL_ALWAYS);
	}
	...
	class MyLinearLayout extends LinearLayout {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX,
			...
			Log.e(TAG, "overScrollBy(" + deltaX + "," + deltaY + "," + scrollX
					+ "," + scrollY + "," + scrollRangeX + "," + scrollRangeY
					+ "," + maxOverScrollX + "," + maxOverScrollY + ","
					+ isTouchEvent + ")");
			return super.overScrollBy(deltaX, deltaY, scrollX, scrollY,
					scrollRangeX, scrollRangeY, maxOverScrollX, 400,
					isTouchEvent);
		}
