 ...
 */
package com.example.myandroid.tooltips;
...
public class ToolTip {
	...
	private boolean mDismissWhenClick = true;
	...
	/**
	 * Set the text resource id to show and the custom typeface for that view.
	 * Has no effect when a content View is set using setContentView().
	 * 
	 * @return this ToolTip to build upon.
	 */
	...
	/**
	 * Set the animation type for the ToolTip. Defaults to
	 * {@link AnimationType#FROM_MASTER_VIEW}.
	 * 
	 * @return this ToolTip to build upon.
	 */
	...
	public ToolTip withProgress(final float progress) {
		mProgress = progress;
		return this;
	}

	public ToolTip withDismiss(final boolean dismissWhenClick) {
		mDismissWhenClick = dismissWhenClick;
		return this;
	}
	...
	public boolean getDismissWhenClick() {
		return mDismissWhenClick;
	}
}
