...
import com.example.myandroid.tooltips.ToolTip;
...
public class TooltipsActivity extends Activity implements View.OnClickListener,
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		setContentView(R.layout.tootips_activity);
	...
	private void addRedToolTipView() {
		ToolTip toolTip = new ToolTip().withText("A beautiful Button")
	...
	private void addGreenToolTipView() {
		ToolTip toolTip = new ToolTip().withText("Another beautiful Button!")
				.withColor(getResources().getColor(R.color.holo_green));

		mGreenToolTipView = mToolTipFrameLayout.showToolTipForView(toolTip,
	...
	private void addBlueToolTipView() {
		ToolTip toolTip = new ToolTip().withText("Moarrrr buttons!")
				.withColor(getResources().getColor(R.color.holo_blue))
				.withAnimationType(ToolTip.AnimationType.FROM_TOP);

		mBlueToolTipView = mToolTipFrameLayout.showToolTipForView(toolTip,
		...
		ToolTip toolTip = new ToolTip()
				.withContentView(
						LayoutInflater.from(this).inflate(
								R.layout.custom_tooltip, null))
				.withColor(getResources().getColor(R.color.holo_purple))
				.withAnimationType(ToolTip.AnimationType.NONE);

		mPurpleToolTipView = mToolTipFrameLayout.showToolTipForView(toolTip,
	...
	private void addOrangeToolTipView() {
		ToolTip toolTip = new ToolTip().withText("Tap me!")
				.withColor(getResources().getColor(R.color.holo_orange))
				.withAnimationType(AnimationType.FROM_MASTER_VIEW)
				.withProgress(0.3f).withDismiss(false);
